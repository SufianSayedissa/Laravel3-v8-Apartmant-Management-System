...
@section('title','Outdoor Social Facilities - '.$setting->title)
@section('description')
    {{$setting->description}}
@endsection
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-6 mb-lg-0 mb-4">
                <a href="{{route('contentdetail',['id'=>$rs->id])}}" target="_blank"><img src="{{Storage::url($rs->image)}}" alt="Image" class="img-fluid" height="350"width="350"></a>
            </div>
